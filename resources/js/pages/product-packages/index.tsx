...
function PackageFormFields({
    ...
    function addAddonGroup() {
        const newGroup: AddonGroup = {
            ...
            is_required: false,
            sort_order: data.addon_groups.length,
            options: [],
        };
    ...
    function removeAddonGroup(gIdx: number) {
        setData(
            'addon_groups',
            data.addon_groups.filter((_, i) => i !== gIdx),
        );
    }
    ...
    return (
        <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
            ...
            >
                <Field label="SKU Paket" error={(errors as any)['sku']}>
                    <input
                        ...
                        placeholder="PKG-001"
                        style={inputStyle(!!(errors as any)['sku'])}
                        disabled={processing}
                    />
                </Field>
                <Field label="Nama Paket" error={(errors as any)['name']}>
                    <input
                        ...
                        placeholder="Paket Hemat 1"
                        style={inputStyle(!!(errors as any)['name'])}
                        disabled={processing}
                    />
                </Field>
            </div>
            ...
            >
                <Field
                    label="Harga Paket"
                    error={(errors as any)['base_price']}
                >
                    <input
                        type="number"
                        min="0"
                        ...
                        placeholder="25000"
                        style={inputStyle(!!(errors as any)['base_price'])}
                        disabled={processing}
                    />
                </Field>
                    ...
                    >
                        ...
                        >
                            ...
                            <input
                                ...
                                placeholder="Keterangan, mis: bagian paha atas (opsional)"
                                style={{
                                    ...inputStyle(),
                                    height: '32px',
                                    fontSize: '12px',
                        ...
                        <button
                            ...
                            style={{
                                marginTop: item.product_id > 0 ? '22px' : '0px',
                                padding: '8px',
                                borderRadius: '8px',
                                border: 'none',
            ...
            >
                Buat grup pilihan yang bisa diganti oleh pelanggan, misalnya
                "Pilihan Minuman" dengan opsi pengganti beserta biaya tambahan.
            </p>
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                <input
                                    ...
                                    placeholder="Nama grup, mis: Pilihan Minuman"
                                    style={inputStyle()}
                                    disabled={processing}
                                />
                                <select
                                    value={group.default_product_id ?? ''}
                                    onChange={(e) =>
                                        updateAddonGroup(
                                            gIdx,
                                            'default_product_id',
                        ...
                        >
                            {group.options.length === 0 && (
                                ...
                                >
                                    Belum ada opsi. Tambahkan opsi pengganti di
                                    bawah.
                                </p>
                            )}
    ...
    return (
        <Modal onClose={onClose} maxWidth="640px">
            <ModalHeader
                ...
                title="Buat Paket Produk Baru"
                subtitle="Susun paket beserta isi dan opsi addon/substitusi"
            />
            <PackageFormFields
                data={data}
                errors={errors}
...
function EditPackageModal({
    ...
    const { data, setData, put, errors, processing } = useForm<PackageFormData>(
        {
            ...
            addon_groups: pkg.addon_groups.map((g) => ({
                ...
                options: g.options.map((o) => ({
                    ...
                    extra_charge: parseFloat(o.extra_charge),
    ...
    return (
        <Modal onClose={onClose} maxWidth="640px">
            <ModalHeader
                icon={<Edit2 size={20} />}
                title="Edit Paket Produk"
                subtitle={`Perbarui informasi paket "${pkg.name}"`}
            />
            <PackageFormFields
                data={data}
                errors={errors}
...
function DeletePackageModal({
    ...
    return (
        <Modal onClose={onClose} maxWidth="380px">
            ...
            >
                Hapus paket <strong>"{pkg.name}"</strong>? Semua item dan addon
            ...
            >
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                    ...
                    >
                        ...
                        {pkg.category && (
                            <Badge color="blue">{pkg.category.name}</Badge>
                        )}
...
// ─── Main Page ────────────────────────────────────────────
export default function ProductPackagesIndex({
    packages,
    recentActivity,
    categories,
    products,
            ...
            >
                ...
                >
                    <div>
                        ...
                        >
                            Kelola bundle / paket produk beserta opsi addon dan
                            substitusi
                        </p>
                    </div>
                    {canCreate && (
                ...
                <div style={{ position: 'relative' }}>
                    ...
                    <input
                        type="text"
                        placeholder="Cari paket berdasarkan nama, SKU, atau kategori..."
                        value={search}
                ...
                {filtered.length === 0 ? (
                    ...
                    >
                        ...
                        >
                            Tidak ada paket produk
                        </p>
                        <p style={{ margin: 0, fontSize: '12px' }}>
                            {search
                                ? 'Tidak ada paket yang cocok dengan pencarian.'
                                : 'Mulai dengan membuat paket pertama Anda.'}
                        </p>
                    </div>
                ) : (
                    <div
                            ...
                            {packages.current_page > 1 && (
                                <button
                                    onClick={() =>
                                        router.get(
                                            buildUrl(
                                                `/product-packages?page=${packages.current_page - 1}`,
                                                teamSlug,
                                            ),
                                        )
                                    }
