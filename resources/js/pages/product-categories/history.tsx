...
import { ArrowLeft, Edit2, FolderPlus, Trash2 } from 'lucide-react';
...
export default function ProductCategoryHistory({
    category,
    activity,
    teamSlug,
}: Props) {
    return (
        <>
            <Head title={`Riwayat Kategori ${category.name}`} />
            ...
            >
                <Link
                    href={buildUrl('/product-categories', teamSlug)}
                    style={{
                        alignItems: 'center',
                        ...
                        <tbody>
                            {activity.data.length === 0 ? (
                                <tr>
                                    ...
                                    >
                                        Belum ada riwayat perubahan untuk
                                        kategori ini
                                    </td>
                                </tr>
                            ) : (
