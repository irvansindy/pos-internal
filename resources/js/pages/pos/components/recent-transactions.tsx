...
export function RecentTransactions({
    ...
    function updateForm(txId: number, values: Partial<SettlementForm>) {
        setForms((prev) => ({
            ...prev,
            [txId]: {
                ...getForm({ id: txId } as RecentTransaction),
                ...values,
            },
        }));
        setErrors((prev) => {
    ...
    function settle(tx: RecentTransaction) {
        ...
        router.post(
            `/${teamSlug}/pos/transaction/${tx.id}/payment`,
            {
                ...
                paid_amount: String(parseNumberInput(form.paid_amount)),
            },
            {
                preserveScroll: true,
    ...
    function sendReceipt(tx: RecentTransaction, channel: 'email' | 'whatsapp') {
        ...
        router.post(
            `/${teamSlug}/pos/transaction/${tx.id}/receipt/${channel}`,
            { [field]: value },
                    ...
                    <tbody>
                        {transactions.length === 0 ? (
                            ...
                            transactions.map((tx) => {
                                ...
                                const voucherLabel = tx.voucher?.code
                                    ? `Voucher ${tx.voucher.code}`
                                    : 'Voucher';
                                                    ...
                                                    >
                                                        ...
                                                        >
                                                            ...
                                                            {tx.status !==
                                                                ...
                                                                >
                                                                    <a
                                                                        href={`/${teamSlug}/pos/transaction/${tx.id}/receipt`}
                                                                        style={{
                                                                            ...receiptButtonStyle,
                                                                            textDecoration:
                                                                                'none',
                                                                ...
                                                                >
                                                                    ...
                                                                    <button
                                                                        onClick={() => {
                                                                            if (
                                                                                window.confirm(
                                                                                    `Batalkan transaksi ${tx.invoice_number}? Stok akan dikembalikan.`,
                                                                                )
                                                                            ) {
                                                                                voidTransaction(
                                                                                    tx,
