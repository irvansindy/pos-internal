        ...
        <>
            ...
            <div className="space-y-6">
                ...
                <div className="grid gap-3 md:grid-cols-2 xl:grid-cols-4">
                    ...
                    <SummaryCard
                        label="Item terjual"
                        value={summary.total_items_sold.toLocaleString('id-ID')}
                    />
                    <SummaryCard
                        label="Total diskon"
                        value={currency(summary.total_discount)}
                        tone="text-amber-600"
                    />
                    <SummaryCard
                        label="Total pajak"
                        value={currency(summary.total_tax)}
                    />
                </div>
                                ...
                                {dailyTrend.map((row) => {
                                    ...
                                    return (
                                        <div
                                            ...
                                            style={{ height: '140px' }}
                                        >
                                            <div className="absolute -top-9 hidden rounded-lg bg-slate-900 px-2 py-1 text-xs whitespace-nowrap text-white group-hover:block">
                        ...
                        <tbody>
                            {topProducts.length === 0 ? (
                                <tr>
                                    ...
                                    >
                                        Belum ada penjualan pada rentang tanggal
                                        ini.
                                    </td>
                                </tr>
                            ) : (
